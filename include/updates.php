...
class Leaky_Paywall_Article_Countdown_Nag_Updates
{
    ...
    public function modify_plugin_update_message($plugin_data, $response)
    {
        ...
        echo '<br />' . sprintf(__('To enable updates, please enter your license key on the <a href="%s">Licenses</a> page. If you don\'t have a licence key, please see <a target="_blank" href="%s">details & pricing</a>.', 'lp-acn'), admin_url('admin.php?page=issuem-leaky-paywall&tab=licenses'), $url);
    }
